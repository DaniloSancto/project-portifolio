...
import dev.danilosantos.portifolio.authDTO.UserDetail;
import dev.danilosantos.portifolio.authDTO.UserSignInRequest;
import dev.danilosantos.portifolio.authDTO.UserSignInResponse;
import dev.danilosantos.portifolio.authDTO.UserSignUpRequest;
import dev.danilosantos.portifolio.authDTO.exception.CustomException;
	...
	public void signUp(@RequestBody UserSignUpRequest userSignUpRequest) {
		...
		try {
			...
			AdminSetUserPasswordRequest adminSetUserPasswordRequest = new AdminSetUserPasswordRequest()
					.withUsername(userSignUpRequest.getUsername()).withUserPoolId(userPoolId)
